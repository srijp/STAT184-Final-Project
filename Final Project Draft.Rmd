...
Since we determined that the states with the highest COVID-19 count are New York and New Jersey, we decided to look at the relationship between COVID-19 count and the state's population for the rest of the country. The glyph in the graph below is the state's abbreviation.
```{r}
