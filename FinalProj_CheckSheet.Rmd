...
author: "Radha Patle and Srija Pinnamaneni"
date: "April 24, 2020"
...
Line 19 (DataComputing Package - ZipGeography dataset)

Lines 25 to 27 (loading in primary dataset)
...
Line 84 (geom_point), line 99 (geom_bar), and line 287 (geom_smooth)

(B) .Rmd Line number(s) for use of multiple aesthetics: 

Line 182 (color), line 303 (size), and line 316 (label)
